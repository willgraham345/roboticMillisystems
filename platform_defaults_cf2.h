...
#define PID_VEL_X_KP 25.0f // changed from 25
#define PID_VEL_X_KI 1.0f // changed from 1
#define PID_VEL_X_KD 5.0f // changed from 0
#define PID_VEL_X_KFF 0.0f

#define PID_VEL_Y_KP 25.0f // changed from 25
#define PID_VEL_Y_KI 1.0f // changed from 1
#define PID_VEL_Y_KD 5.0f // changed from 0
#define PID_VEL_Y_KFF 0.0f

#define PID_VEL_Z_KP 25.0f // changed from 25
#define PID_VEL_Z_KI 15.0f // changed from 15
#define PID_VEL_Z_KD 0.0f // changed from 0
...
#define PID_POS_X_KP 0.5f //changed from 2
#define PID_POS_X_KI 0.05f // changed from 0
#define PID_POS_X_KD 0.1f  //changed from 0
#define PID_POS_X_KFF 0.0f

#define PID_POS_Y_KP 0.5f //changed from 2
#define PID_POS_Y_KI 0.05f // changed from 0
#define PID_POS_Y_KD 0.1f //changed from 0
#define PID_POS_Y_KFF 0.0f

#define PID_POS_Z_KP 2.0f //changed from 2
#define PID_POS_Z_KI 0.5f
#define PID_POS_Z_KD 0.0f
#define PID_POS_Z_KFF 0.0f

#define PID_POS_VEL_X_MAX 0.3f
#define PID_POS_VEL_Y_MAX 0.3f //changed from 2
